  ...
  return (
    <>
      ...
      <section className="pt-16 max-w-4xl text-center mx-auto container space-y-6">
        <h1 className="text-5xl font-extrabold text-teal-500">دوربین</h1>
        ...
        <Link
          href={"/blogs"}
          className="md:w-[280px] w-[200px] bg-teal-500 text-white mx-auto h-[45px] mt-8 text-lg rounded-xl flex items-center justify-center hover:bg-teal-600 transition-all duration-300 font-medium"
        >
          شروع کنید
